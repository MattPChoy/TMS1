package tms.sensors;
/**
 * From JavaDoc (https://csse2002.uqcloud.net/assignment/1/tms/sensors/DemoSpeedCamera.html)
...
public class DemoSpeedCamera extends DemoSensor implements SpeedCamera{
    ...
    /**
     * Calculates the congestion rate as the complement of the percentage given by
       averageSpeed() divided by getThreshold().
     * For example, a route with an average speed of 60 km/h and a threshold value of 100 km/h
       would be 40 percent congested.
     *
